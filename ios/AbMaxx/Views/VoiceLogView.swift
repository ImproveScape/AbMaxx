...
struct VoiceLogView: View {
    ...
    private let deepAccent = Color(red: 0.10, green: 0.35, blue: 0.85)
    private let darkAccent = Color(red: 0.08, green: 0.20, blue: 0.55)
    ...
    private var contentForPhase: some View {
        if voiceService.permissionDenied {
    ...
    private var permissionDeniedView: some View {
        VStack(spacing: 16) {
            ...
            Image(systemName: "mic.slash.fill")
                .font(.system(size: 36))
                .foregroundStyle(brandAccent.opacity(0.6))
            Text("Microphone Access Required")
                .font(.system(size: 16, weight: .semibold))
                .foregroundStyle(.white.opacity(0.8))
            Text("Enable microphone access in Settings to use voice logging.")
                .font(.system(size: 13))
