...
nonisolated struct Exercise: Identifiable, Codable, Sendable {
    ...
    static let allExercises: [Exercise] = [
        // MARK: - Deep Core
        Exercise(id: "plank", name: "Plank", region: .deepCore, reps: "45 sec × 3 sets",
        ...
        Exercise(id: "dead_bug", name: "Dead Bug", region: .deepCore, reps: "15 reps × 3 sets",
        ...
        Exercise(id: "bird_dog", name: "Bird Dog", region: .deepCore, reps: "15 reps × 3 sets",
        ...
        Exercise(id: "hollow_hold", name: "Hollow Body Hold", region: .deepCore, reps: "45 sec × 3 sets",
        ...
        Exercise(id: "stomach_vacuum", name: "Stomach Vacuum", region: .deepCore, reps: "30 sec × 5 sets",
        ...
        Exercise(id: "side_plank", name: "Side Plank", region: .deepCore, reps: "45 sec each side × 3 sets",
        ...
        Exercise(id: "slow_mountain_climbers", name: "Slow Mountain Climbers", region: .deepCore, reps: "40 sec × 3 sets",
        ...
        // MARK: - Upper Abs
        Exercise(id: "crunches", name: "Crunches", region: .upperAbs, reps: "25 reps × 3 sets",
        ...
        Exercise(id: "sit_ups", name: "Sit Ups", region: .upperAbs, reps: "20 reps × 3 sets",
        ...
        Exercise(id: "toe_touch_control", name: "Toe Touch Control", region: .upperAbs, reps: "15 reps × 3 sets",
        ...
        Exercise(id: "cable_crunch", name: "Cable Crunch", region: .upperAbs, reps: "15 reps × 3 sets",
        ...
        Exercise(id: "decline_crunch", name: "Decline Crunch", region: .upperAbs, reps: "15 reps × 3 sets",
        ...
        Exercise(id: "crunch_hold", name: "Crunch Hold", region: .upperAbs, reps: "30 sec × 3 sets",
        ...
        Exercise(id: "weighted_crunch", name: "Weighted Crunch", region: .upperAbs, reps: "10 reps × 3 sets",
        ...
        Exercise(id: "ab_rollout", name: "Ab Rollout", region: .upperAbs, reps: "15 reps × 3 sets",
        ...
        Exercise(id: "v_ups", name: "V-Ups", region: .upperAbs, reps: "15 reps × 3 sets",
        ...
        Exercise(id: "pulse_crunches", name: "Pulse Crunches", region: .upperAbs, reps: "30 reps × 3 sets",
        ...
        // MARK: - Lower Abs
        Exercise(id: "hanging_leg_raises", name: "Hanging Leg Raises", region: .lowerAbs, reps: "15 reps × 2 sets",
        ...
        Exercise(id: "reverse_crunches", name: "Reverse Crunches", region: .lowerAbs, reps: "12 reps × 3 sets",
        ...
        Exercise(id: "flutter_kicks", name: "Flutter Kicks", region: .lowerAbs, reps: "30 sec × 3 sets",
        ...
        Exercise(id: "scissor_kicks", name: "Scissor Kicks", region: .lowerAbs, reps: "30 sec × 3 sets",
        ...
        Exercise(id: "leg_raises", name: "Leg Raises", region: .lowerAbs, reps: "15 reps × 3 sets",
        ...
        Exercise(id: "l_sit_hold", name: "L-Sit Hold", region: .lowerAbs, reps: "30 sec × 3 sets",
        ...
        Exercise(id: "mountain_climbers", name: "Mountain Climbers", region: .lowerAbs, reps: "60 sec × 3 sets",
        ...
        Exercise(id: "toe_raise_lying", name: "Toe Raise (Lying)", region: .lowerAbs, reps: "20 reps × 3 sets",
        ...
        Exercise(id: "bench_leg_raises", name: "Bench Leg Raises", region: .lowerAbs, reps: "15 reps × 3 sets",
        ...
        Exercise(id: "reverse_crunch_pulse", name: "Reverse Crunch Pulse", region: .lowerAbs, reps: "15 reps × 3 sets",
        ...
        // MARK: - Obliques
        Exercise(id: "russian_twists", name: "Russian Twists", region: .obliques, reps: "30 reps × 3 sets",
        ...
        Exercise(id: "bicycle_crunch", name: "Bicycle Crunch", region: .obliques, reps: "20 reps × 3 sets",
        ...
        Exercise(id: "side_plank_dips", name: "Side Plank Dips", region: .obliques, reps: "12 each side × 3 sets",
        ...
        Exercise(id: "oblique_crunch", name: "Oblique Crunch", region: .obliques, reps: "15 each side × 3 sets",
        ...
        Exercise(id: "heel_taps", name: "Heel Taps", region: .obliques, reps: "30 reps × 3 sets",
        ...
        Exercise(id: "cross_body_mountain_climbers", name: "Cross Body Mountain Climbers", region: .obliques, reps: "30 sec × 3 sets",
        ...
        Exercise(id: "windshield_wipers", name: "Windshield Wipers", region: .obliques, reps: "15 reps × 3 sets",
        ...
        Exercise(id: "twisting_sit_ups", name: "Twisting Sit Ups", region: .obliques, reps: "12 reps × 3 sets",
