...
nonisolated struct BodyFatEntry: Codable, Identifiable, Sendable {
    ...
    static func estimateBodyFat(gender: Gender, waistInches: Double, weightLbs: Double, heightInches: Double) -> Double {
        ...
        case .other:
            let bfMale = 86.010 * log10(waistInches) - 70.041 * log10(heightInches) + 36.76
            let bfFemale = 163.205 * log10(waistInches) - 97.684 * log10(heightInches) - 78.387
            return max(5, min(50, (bfMale + bfFemale) / 2.0))
        }
    }
