...
struct RedMotivationPageView: View {
    ...
    private var standardSlide: some View {
        ZStack {
            ...
            VStack(spacing: 0) {
                ...
                AsyncImage(url: URL(string: pageData.imageURL)) { phase in
    ...
    private var disciplinePathSlide: some View {
        GrowthChartSlide(onBack: onBack, onNext: onNext, currentPage: currentPage, totalPages: totalPages, currentScore: currentScore)
    }
