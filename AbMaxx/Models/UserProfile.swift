...
nonisolated struct UserProfile: Codable, Sendable {
    ...
    var estimatedWeeksToAbs: Int {
        ...
        case .veryActive, .extraActive: modifier = 0.7
        case .moderatelyActive, .moderate: modifier = 0.85
    ...
    var tdee: Double {
        ...
        case .moderate, .moderatelyActive: multiplier = 1.55
    ...
    func toDailyNutrition() -> DailyNutrition {
        ...
        n.calorieGoal = calculatedCalorieGoal
        n.proteinGoal = calculatedProteinGoal
        n.carbsGoal = calculatedCarbsGoal
        n.fatGoal = calculatedFatGoal
...
nonisolated enum ActivityLevel: String, Codable, CaseIterable, Sendable {
    ...
    var description: String {
        ...
        case .extraActive: "Intense training twice daily"
        }
    }
